        ...
        <main className="min-h-screen text-white p-6 md:p-12 flex items-center justify-center">
                <div className="container max-w-4xl mx-auto text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <Link href="/radar/app-download" className="block p-12 bg-gradient-to-br from-purple-600 to-purple-800 rounded-xl shadow-xl hover:scale-105 transition-transform">
                            <i className="ion-ios-download text-6xl mx-auto mb-6 text-white block"></i>
                            <h2 className="text-3xl font-semibold text-white" style={{fontFamily: 'Montserrat, sans-serif'}}>App Download</h2>
                            <p className="text-slate-200 mt-3 text-lg" style={{fontFamily: 'Montserrat, sans-serif'}}>Baixe nosso aplicativo de rastreamento móvel.</p>
                        </Link>
                    </div>
                </div>
            </main>
