                ...
                <div className="container max-w-4xl mx-auto neumorphic-container p-6 md:p-8">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start mb-6">
                        ...
                        <div className="flex gap-2 mt-4 sm:mt-0 no-print">
                            ...
                            <Link href={`/clientes/alterar/${cliente.idCliente}`} className="neumorphic-button">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="neumorphic-fieldset p-6">
                            <legend className="neumorphic-legend flex items-center font-montserrat">
                                <i className="ion-ios-person mr-2 text-cyan-400 text-xl"></i> Dados Pessoais
                            </legend>
                        ...
                        <div className="neumorphic-fieldset p-6">
                            <legend className="neumorphic-legend flex items-center font-montserrat">
                                <i className="ion-ios-call mr-2 text-emerald-400 text-xl"></i> Contato
                            </legend>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3 text-sm mt-4">
                                <div className="flex items-center gap-2">
                        ...
                        {cliente.cnhResponseDto && (
                            <div className="neumorphic-fieldset p-6">
                                <legend className="neumorphic-legend flex items-center font-montserrat">
                                    <i className="ion-ios-card mr-2 text-purple-400 text-xl"></i> Dados de CNH
                                </legend>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3 text-sm mt-4">
                                    <div className="flex items-center gap-2">
                                        <i className="ion-ios-document text-purple-500"></i>
                                        <span className="text-gray-800 font-montserrat"><strong>Número de Registro:</strong> {cliente.cnhResponseDto.numeroRegistro}</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <i className="ion-ios-calendar text-purple-500"></i>
                                    ...
                                    <div className="flex items-center gap-2">
                                        <i className="ion-ios-calendar-outline text-purple-500"></i>
                                    ...
                                    <div className="flex items-center gap-2">
                                        <i className="ion-ios-car text-purple-500"></i>
                        ...
                        <div className="neumorphic-fieldset p-6">
                            <legend className="neumorphic-legend flex items-center font-montserrat">
                                <i className="ion-ios-location mr-2 text-rose-400 text-xl"></i> Endereço
                            </legend>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3 text-sm mt-4">
                                <div className="flex items-center gap-2">
