...
const navItems: Array<{
    ...
    { href: "/mapa-2d", label: "Mapa2D", icon: "ion-ios-map", basePath: "/mapa-2d" },
    {
        ...
        subItems: [
            ...
            { href: "http://localhost:8080/swagger-ui/index.html", label: "Swagger", icon: "ion-ios-code" },
        ]
    },
    ...
    return (
        <header className="w-full sticky top-0 z-50">
            <nav className="w-full bg-[var(--color-mottu-dark)] text-white shadow-md navbar-gradient">
                ...
                {isMobileMenuOpen && (
                    <div className="md:hidden bg-[var(--color-mottu-dark)] border-t border-slate-700 navbar-gradient">
