                ...
                <div className="container max-w-4xl mx-auto neumorphic-container p-6 md:p-8">
                    <div className="flex flex-col sm:flex-row justify-between items-start mb-6">
                        ...
                        <div className="flex gap-2 mt-4 sm:mt-0">
                            <Link href="/gerenciamento-patio/patio" className="btn btn-ghost">
                                <ArrowLeft size={18} className="text-blue-500"/> Voltar
                            </Link>
                            <Link href={`/patio/alterar/${patio.idPatio}`} className="btn btn-primary-green">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="p-4 rounded-lg neumorphic-container">
                            <h2 className="text-xl font-semibold mb-3 flex items-center"><Building className="mr-2 text-emerald-600"/>Dados do Pátio</h2>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3 text-sm text-gray-800">
                                ...
                                <div className="flex items-center gap-2">
                                    <i className={`ion-ios-pulse ${patio.status === 'A' ? 'text-green-600' : 'text-red-600'}`}></i>
                        ...
                        <div className="p-4 rounded-lg neumorphic-container">
                            <h2 className="text-xl font-semibold mb-3 flex items-center"><Phone className="mr-2 text-sky-600"/>Contato Principal</h2>
                            {patio.contato ? (
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3 text-sm text-gray-800">
                                    <div className="flex items-center gap-2">
                                        <i className="ion-ios-mail text-green-600"></i>
                                        <span><strong>Email:</strong> <span className="text-sky-700">{patio.contato.email}</span></span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <i className="ion-ios-phone-portrait text-green-600"></i>
                                        <span><strong>Celular:</strong> {patio.contato.celular}</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <i className="ion-ios-call text-green-600"></i>
                                        <span><strong>Telefone:</strong> ({patio.contato.ddd}) {patio.contato.telefone1}</span>
                                    </div>
                                    {patio.contato.ddi && (
                                        <div className="flex items-center gap-2">
                                            <i className="ion-ios-globe text-green-600"></i>
                        ...
                        <div className="p-4 rounded-lg neumorphic-container">
                            <h2 className="text-xl font-semibold mb-3 flex items-center"><Home className="mr-2 text-purple-600"/>Endereço Principal</h2>
                            {patio.endereco ? (
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-3 text-sm text-gray-800">
                                    <div className="flex items-center gap-2 md:col-span-2">
