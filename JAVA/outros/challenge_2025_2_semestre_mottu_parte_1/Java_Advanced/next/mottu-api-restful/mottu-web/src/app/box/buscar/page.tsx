                  ...
                  <form onSubmit={handleSearch} className="mb-8 neumorphic-container">
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select 
                                    ...
                                    value={filter.status || ''} 
                                    onChange={handleFilterChange} 
                                    className="neumorphic-select w-full h-12" 
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <label className="block text-sm font-medium text-white mb-2 flex items-center gap-2" htmlFor="dataEntradaInicio">
                                ...
                                <input 
                                    ...
                                    onChange={handleFilterChange} 
                                    className="neumorphic-input w-full h-12 date-input-fix" 
                                    title="Data de entrada inicial"
                                />
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-white mb-2 flex items-center gap-2" htmlFor="dataEntradaFim">
                                    <i className="ion-ios-calendar text-blue-500"></i>
                                    Data Entrada (Fim)
                                </label>
                                <input 
                  ...
                  {isLoading && (
                    <div className="neumorphic-container text-center py-12">
                      <div className="flex flex-col items-center gap-4">
                        ...
                        <p className="text-slate-300 font-montserrat">Buscando boxes...</p>
                      </div>
                    </div>
                  )}
                    ...
                    <div className="neumorphic-container text-center py-12">
                      <div className="flex flex-col items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-slate-400 font-montserrat">Nenhum box encontrado para os critérios informados.</p>
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  {!isLoading && boxes.length > 0 && (
                    viewType === 'cards' ? (
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                        {boxes.map((box) => (
                          <div key={box.idBox} className="neumorphic-card-gradient p-5 flex flex-col justify-between transition-all duration-300 hover:shadow-2xl hover:scale-105 transform hover:-translate-y-2 cursor-pointer">
                            <div>
                              ...
                              {box.observacao && (
                                <p className="text-sm text-slate-500 mb-3 line-clamp-2">{box.observacao}</p>
                              )}
                            </div>
                            ...
                            <tbody className="bg-white divide-y divide-slate-200">
                              {boxes.map((box) => (
                                <tr key={box.idBox} className="hover:bg-slate-50 transition-all duration-300 hover:shadow-lg">
                                  <td className="px-4 py-4 whitespace-nowrap text-sm text-slate-600 font-montserrat">{box.idBox}</td>
                                  <td className="px-4 py-4 whitespace-nowrap text-sm font-medium text-slate-900 font-montserrat">{box.nome}</td>
