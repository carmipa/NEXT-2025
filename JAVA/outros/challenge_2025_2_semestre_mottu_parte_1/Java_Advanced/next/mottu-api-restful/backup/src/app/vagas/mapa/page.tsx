            ...
            if (alive) {
                ...
                if (patioId) {
                    ...
                    if (data.boxes.length > 0) {
                        ...
                        if (primeiroBox.nome.startsWith('B') || primeiroBox.nome.startsWith('GRU')) {
            ...
            <main className="min-h-screen text-white p-6">
                <div className="mx-auto max-w-5xl">
                                ...
                                {paginatedBoxes.map((b) => {
                                    ...
                                    return (
                                        <div
                                            key={b.idBox}
                                            className={[
                                                "relative rounded-xl border p-4 transition duration-300 ease-in-out flex flex-col justify-between",
                                        ...
                                        >
                                            {isHighlighted && highlightedVehicle ? (
                                                <>
                                                    <div>
                                                        <div className="text-sm text-amber-300 font-bold">{b.nome}</div>
                                                    ...
                                                    <div className="mt-auto pt-2 flex items-center justify-end gap-2">
                                                        <button
                                                            ...
                                                            <i className="ion-ios-eye"></i> <span style={{fontFamily: 'Montserrat, sans-serif'}}>Detalhes</span>
                                                        </button>
                                                        <button
                                                    ...
                                                    <div className="mt-auto pt-2">
                                                        {ocupado ? (
                                                            <div className="flex items-center justify-end gap-2">
                                                                ...
                                                                <button onClick={() => onLiberar(b.idBox)} className="px-3 py-1 rounded-lg bg-rose-600 hover:bg-rose-700 text-sm"> Liberar </button>
                                                            </div>
                                            ...
                                            return (
                                                ...
                                                >
                                                    <td className="py-3 px-4 font-mono">
                                                        {isHighlighted ? (
                                                            <span className="text-amber-300 font-bold">{b.nome}</span>
                                                        ) : (
                                                            b.nome || `BOX ${b.idBox}`
                                                        )}
                                                    </td>
                        ...
                        <div className="mt-6 flex flex-col items-center gap-4">
                            ...
                            <div className="flex items-center gap-2 text-sm text-zinc-400">
                                ...
                                <input
                                    ...
                                    className="w-16 px-2 py-1 bg-zinc-800 border border-zinc-600 rounded text-center text-white"
                    ...
                    <div className="mt-6 flex flex-wrap gap-3 justify-center">
                        <button onClick={() => router.push("/radar/buscar")} className="px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-700 flex items-center gap-2">
                            <i className="ion-ios-search"></i> <span style={{fontFamily: 'Montserrat, sans-serif'}}>Buscar outra placa</span>
                        </button>

                        {/* BOTÃO ALTERADO */}
                        <button onClick={() => router.push("/radar")} className="px-4 py-2 rounded-xl bg-zinc-700 hover:bg-zinc-600 flex items-center gap-2">
                            <i className="ion-ios-arrow-back"></i> <span style={{fontFamily: 'Montserrat, sans-serif'}}>Voltar ao Radar</span>
                        </button>

                        <Link href={getMapaUrl()} className="px-4 py-2 rounded-xl bg-blue-800 hover:bg-blue-700 flex items-center gap-2">
                            <i className="ion-ios-map"></i> <span style={{fontFamily: 'Montserrat, sans-serif'}}>Ver Mapa Interativo</span>
                        </Link>
                    </div>
                </div>
                        ...
                        <div className="bg-zinc-900 rounded-xl shadow-xl p-6 w-full max-w-md text-white border border-zinc-700 animate-slide-up" onClick={(e) => e.stopPropagation()}>
                            <div className="flex justify-between items-center mb-6">
                                <h2 className="text-2xl font-bold flex items-center gap-2 text-emerald-400">
                                    <i className="ion-ios-bicycle text-2xl"></i> <span style={{fontFamily: 'Montserrat, sans-serif'}}>Detalhes da Moto</span>
                                </h2>
