...
export default function HomePage() {
    ...
    return (
        <>
            ...
            <main
                className="flex items-center justify-center h-screen text-white overflow-hidden"
            ...
            >
                ...
                <PcarTiltCard imageSrc="/fotos-equipe/fundo_pcar.png">
                    ...
                    <div className="bg-black rounded-xl p-3 max-w-xl mx-auto mb-4 border border-white/10 pcar-text">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-2 pcar-actions">
                        <Link href="/dashboard">
