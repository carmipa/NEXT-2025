...
import { Tag, Calendar, Text, Info, Loader2, AlertCircle, Stethoscope, ArrowLeft } from 'lucide-react';
                ...
                <div className="container mx-auto bg-[var(--color-mottu-default)] p-6 md:p-8 rounded-lg shadow-xl">
                    <div className="flex justify-between items-start mb-6">
                        ...
                        <Link 
                            ...
                            className="flex items-center gap-2 px-4 py-2 bg-slate-600 hover:bg-slate-500 text-white rounded-md transition-colors text-sm"
                        >
                            <ArrowLeft size={18} />
                            Voltar ao Gerenciamento
                        </Link>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    maxLength={50}
                                    className="w-full p-2 h-10 rounded bg-white border border-slate-300 text-slate-900 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    required
                                    className="w-full p-2 h-10 rounded bg-white border border-slate-300 text-slate-900 focus:outline-none focus:ring-2 focus:ring-emerald-500 date-input-fix"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    maxLength={100}
                                    className="w-full p-2 rounded bg-white border border-slate-300 text-slate-900 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                                />
                            </div>
                            ...
                            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                                <button
                                    type="submit"
                                    className={`flex items-center justify-center gap-2 px-6 py-3 font-semibold text-white bg-emerald-600 rounded-md shadow hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 focus:ring-offset-slate-900 transition-opacity duration-300 ${isLoading || isFetching ? 'opacity-50 cursor-not-allowed' : ''}`}
                                ...
                                >
                                    <MdArrowBack size={20} /> Voltar ao Gerenciamento
                                </Link>
                            </div>
                        </form>
                    </div>
