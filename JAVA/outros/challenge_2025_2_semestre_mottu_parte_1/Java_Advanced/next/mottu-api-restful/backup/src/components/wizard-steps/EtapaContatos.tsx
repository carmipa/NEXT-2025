    ...
    return (
        <div className="space-y-6 animate-fade-in">
            <h2 className="text-xl font-semibold text-white flex items-center gap-2">
                <Phone size={20} /> 2. Dados de Contato
            </h2>
            ...
            <div className="space-y-4">
                {/* E-mail */}
                <div className="group">
                    <label htmlFor="email" className="block text-sm font-medium text-slate-100 mb-1 flex items-center gap-2">
                        <Mail size={16} /> E-mail <span className="text-red-400">*</span>
                    </label>
                    <input
                        type="email"
                        id="email"
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="group">
                        <label htmlFor="ddd" className="block text-sm font-medium text-slate-100 mb-1 flex items-center gap-2">
                            <Phone size={16} /> DDD <span className="text-red-400">*</span>
                        </label>
                        <input
                            type="number"
                            id="ddd"
                    ...
                    <div className="group">
                        <label htmlFor="ddi" className="block text-sm font-medium text-slate-100 mb-1 flex items-center gap-2">
                            <Phone size={16} /> DDI <span className="text-red-400">*</span>
                        </label>
                        <input
                            type="number"
                            id="ddi"
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="group">
                        <label htmlFor="telefone1" className="block text-sm font-medium text-slate-100 mb-1 flex items-center gap-2">
                            <Phone size={16} /> Telefone Fixo <span className="text-red-400">*</span>
                        </label>
                        <IMaskInput
                            id="telefone1"
                            name="telefone1"
                    ...
                    <div className="group">
                        <label htmlFor="celular" className="block text-sm font-medium text-slate-100 mb-1 flex items-center gap-2">
                            <Phone size={16} /> Celular <span className="text-red-400">*</span>
                        </label>
                        <IMaskInput
                            id="celular"
                            name="celular"
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="group">
                        <label htmlFor="telefone2" className="block text-sm font-medium text-slate-100 mb-1 flex items-center gap-2">
                            <Phone size={16} /> Telefone 2
                        </label>
                        <IMaskInput
                            id="telefone2"
                            name="telefone2"
                    ...
                    <div className="group">
                        <label htmlFor="telefone3" className="block text-sm font-medium text-slate-100 mb-1 flex items-center gap-2">
                            <Phone size={16} /> Telefone 3
                        </label>
                        <IMaskInput
                            id="telefone3"
                            name="telefone3"
                ...
                {/* Outro contato */}
                <div className="group">
                    <label htmlFor="outro" className="block text-sm font-medium text-slate-100 mb-1 flex items-center gap-2">
                        <Phone size={16} /> Outro Contato
                    </label>
                    <input
                        type="text"
                        id="outro"
                ...
                <div className="group">
                    <label htmlFor="observacao" className="block text-sm font-medium text-slate-100 mb-1 flex items-center gap-2">
                        <Phone size={16} /> Observações do Contato
                    </label>
                    <textarea
                        id="observacao"
                        name="observacao"
