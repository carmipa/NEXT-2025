        ...
        <>
            ...
            <main className="min-h-screen text-white p-4 md:p-8">
                <div className="container mx-auto bg-[var(--color-mottu-default)] p-6 md:p-8 rounded-lg shadow-xl">
                    <h1 className="flex items-center justify-center gap-2 text-2xl md:text-3xl font-bold mb-6 text-center text-white" style={{fontFamily: 'Montserrat, sans-serif'}}>
                        <i className="ion-ios-search text-3xl"></i> Buscar Clientes
                    </h1>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 items-end">
                                ...
                                <div className="lg:col-span-4 flex flex-col sm:flex-row justify-center items-center gap-3 pt-2">
                                    <button type="submit" className="neumorphic-button-green">
                                        <i className="ion-ios-search mr-2"></i> Buscar Clientes
                                    </button>
                                    ...
                                    {clientes.map((cliente) => (
                                        <div key={cliente.idCliente} className="neumorphic-container p-6 flex flex-col justify-between transition-all hover:scale-105">
                                            ...
                                            <div className="flex justify-end items-center gap-2 pt-4 mt-auto">
                                                ...
                                                <Link href={`/clientes/deletar/${cliente.idCliente}`} className="p-2 rounded-full text-red-500 hover:bg-red-100 transition-colors" title="Excluir Cliente"><i className="ion-ios-trash text-xl"></i></Link>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                                                    ...
                                                    <tr key={cliente.idCliente} className="hover:bg-slate-50 transition-colors">
                                                        ...
                                                        <td className="px-4 py-3">
                                                            <div className="flex justify-center items-center gap-2">
                                                                <Link href={`/clientes/detalhes/${cliente.idCliente}`} className="p-1 rounded text-blue-600 hover:bg-blue-100 transition-colors" title="Ver Detalhes"><i className="ion-ios-eye"></i></Link>
                                                                <Link href={`/clientes/alterar/${cliente.idCliente}`} className="p-1 rounded text-yellow-500 hover:bg-yellow-100 transition-colors" title="Editar Cliente"><i className="ion-ios-create"></i></Link>
                                                                <Link href={`/clientes/deletar/${cliente.idCliente}`} className="p-1 rounded text-red-500 hover:bg-red-100 transition-colors" title="Excluir Cliente"><i className="ion-ios-trash"></i></Link>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                ))}
