        ...
        <>
            ...
            <main className="min-h-screen text-white p-4 md:p-8">
                <div className="container mx-auto space-y-8">
                    ...
                    {/* MUDANÇA: trocado 'justify-center' por 'justify-between' para alinhar nas bordas */}
                    <div className="w-full flex items-stretch justify-between gap-4">
                        ...
                        <StatCard 
                            ...
                            icon={<i className="ion-ios-grid text-green-500 text-xl"></i>} 
                        />
                        <StatCard 
                        ...
                        <section className="neumorphic-container p-6 transition-all duration-300 hover:shadow-2xl hover:scale-[1.02]">
                            <div className="flex items-center justify-between mb-4">
                                <h2 className="text-xl font-semibold flex items-center text-slate-800" style={{fontFamily: 'Montserrat, sans-serif'}}>
                                    <i className="ion-ios-analytics mr-2 text-green-500 text-xl"></i> Ocupação por Dia
                                </h2>
                    ...
                    <div className="neumorphic-fieldset p-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                {currentVeiculos.length > 0 ? (
                                    currentVeiculos.map((v) => (
                                        <div key={v.idVeiculo} className="neumorphic-container p-5 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-emerald-500/20 cursor-pointer">
                                            <div className="flex items-center justify-between mb-4">
                                            ...
                                            <div className="space-y-3 text-sm mb-4">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-slate-800" style={{fontFamily: 'Montserrat, sans-serif'}}><strong>Modelo:</strong> {v.modelo}</span>
                                                </div>
                                                <div className="flex items-center gap-2">
                                                    <i className="ion-ios-square text-green-500"></i>
                                                    <span className="text-slate-800" style={{fontFamily: 'Montserrat, sans-serif'}}><strong>Box:</strong> {v.boxAssociado?.nome}</span>
                                                </div>
                                                <div className="flex items-center gap-2">
                                                    <i className="ion-ios-home text-red-500"></i>
                                                    <span className="text-slate-800" style={{fontFamily: 'Montserrat, sans-serif'}}><strong>Pátio:</strong> {v.patioAssociado?.nomePatio || "-"}</span>
                                                </div>
                                            </div>
                        ...
                        {veiculosEstacionados.length > 0 && (
                            <div className="mt-6 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-slate-200">
                                <div className="flex items-center gap-2">
                                    <span>
