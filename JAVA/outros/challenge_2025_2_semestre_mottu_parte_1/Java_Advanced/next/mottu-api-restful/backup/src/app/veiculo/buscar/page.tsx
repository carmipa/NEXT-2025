                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 items-end">
                                ...
                                <div className="lg:col-span-full flex flex-col sm:flex-row justify-center items-center gap-3 pt-2">
                                    <button type="submit" className="neumorphic-button-green">
                                        <i className="ion-ios-search mr-2"></i> Buscar
                                    </button>
                            ...
                            {viewType === 'cards' ? (
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                                    {veiculos.map((veiculo) => (
                                        <div key={veiculo.idVeiculo} className="neumorphic-container p-6 flex flex-col justify-between transition-all hover:scale-105">
                                            <div>
