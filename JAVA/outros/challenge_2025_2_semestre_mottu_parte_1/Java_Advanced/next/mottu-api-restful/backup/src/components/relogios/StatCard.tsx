...
export const StatCard = ({ title, value, icon }: StatCardProps) => {
    return (
        // O card principal com o fundo verde que definimos no CSS
        <div
            style={{ backgroundColor: 'var(--color-mottu-stats-card)' }}
            className="p-4 rounded-lg shadow-lg flex items-center space-x-4 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-emerald-500/30 cursor-pointer"
        >
