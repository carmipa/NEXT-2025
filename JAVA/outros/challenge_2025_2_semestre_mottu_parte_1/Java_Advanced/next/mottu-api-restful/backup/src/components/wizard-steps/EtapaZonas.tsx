...
const EtapaZonas: React.FC<EtapaZonasProps> = ({ wizardData, setWizardData }) => {
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            <h2 className="text-xl font-semibold text-white">3. Adicionar Zonas ao Pátio</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-slate-900/50 p-4 rounded-lg space-y-4">
                    ...
                    <div className="group">
                        <label htmlFor="nomeNovaZona" className="block text-sm font-medium text-slate-100 mb-1">
                            Nome da Zona <span className="text-red-400">*</span>
                        </label>
                        <input
                            type="text"
                            id="nomeNovaZona"
                    ...
                    <div>
                        <label htmlFor="observacaoNovaZona" className="block text-sm font-medium text-slate-100 mb-1">
                            Observação (Opcional)
                        </label>
                        <textarea
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-2 px-4 py-2 font-semibold text-white bg-green-600 rounded-md shadow hover:bg-green-700"
                    >
                        <PlusCircle size={18} />
                    ...
                    <div className="max-h-64 overflow-y-auto space-y-2 pr-2">
                        {wizardData.zonas.length > 0 ? (
                            wizardData.zonas.map((zona, index) => (
                                <div key={index} className="bg-slate-800 p-3 rounded-md flex justify-between items-start animate-fade-in">
                                    <div>
                                    ...
                                    <button
                                        ...
                                        className="p-1 text-red-400 hover:bg-red-900/50 rounded-full"
