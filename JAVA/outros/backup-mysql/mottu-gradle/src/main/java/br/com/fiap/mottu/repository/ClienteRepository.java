...
public interface ClienteRepository extends JpaRepository<Cliente, Long>, JpaSpecificationExecutor<Cliente> {
    ...
    // Métodos para verificar se contato/endereço ainda está sendo usado
    boolean existsByContatoIdContato(Long contatoId);
    boolean existsByEnderecoIdEndereco(Long enderecoId);
