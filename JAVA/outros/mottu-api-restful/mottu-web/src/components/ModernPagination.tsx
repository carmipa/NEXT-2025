...
export default function ModernPagination({
  ...
  return (
    <div className={`flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 p-4 sm:p-6 neumorphic-container ${className}`}>
      {/* Informações da página */}
      <div className="text-xs sm:text-sm text-slate-300 font-montserrat">
      ...
      <div className="flex items-center gap-1 sm:gap-2">
        ...
        <button
          ...
          className={`
            ...
            transition-all duration-200 hover:scale-105 neumorphic-button
            ${currentPage === 1
            ...
            return (
              <button
                ...
                className={`
                  ...
                  transition-all duration-200 hover:scale-110 neumorphic-button
                  ${isActive
      ...
      {showPageInput && (
        <div className="flex items-center gap-2 text-xs sm:text-sm text-slate-300">
          ...
          <input
            ...
            className="w-12 sm:w-16 px-2 py-1 text-center neumorphic-input text-xs sm:text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
