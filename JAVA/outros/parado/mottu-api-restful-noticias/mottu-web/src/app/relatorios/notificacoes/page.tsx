...
export default function NotificacoesPage() {
    ...
    const carregarNotificacoes = async () => {
        ...
        try {
            ...
            const notificacoesProcessadas: Notificacao[] = data.content?.map((notif: any) => ({
                id: notif.idNotificacao || notif.id,
                tipo: notif.tipo?.toLowerCase() || 'info',
                titulo: notif.titulo || 'Notificação',
                mensagem: notif.mensagem || 'Sem mensagem',
                dataHora: notif.dataHoraCriacao || notif.dataHora || new Date().toISOString(),
                lida: notif.lida || false,
                prioridade: notif.prioridade?.toLowerCase() || 'media',
                categoria: notif.categoria?.toLowerCase() || 'sistema',
                urlRedirecionamento: notif.urlRedirecionamento || null
            })) || [];
                    ...
                    <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between space-y-4 lg:space-y-0">
                        ...
                        <div className="flex items-center space-x-3 lg:space-x-4">
                            ...
                            <div className="text-center">
                                ...
                                <div className="text-xs lg:text-sm text-gray-500">Críticas</div>
                            </div>
                        </div>
                    </div>
                </div>
