...
const sections = [
    ...
    },
    {
        ...
        links: [
            { name: "API Swagger", path: "http://72.61.219.15:8080/swagger-ui/index.html", icon: <i className="ion-ios-document text-blue-500"></i>, detail: "Documentação completa da API REST com interface Swagger UI." }
        ]
    },
    {
        name: "📰 Central de Notícias",
        icon: <i className="ion-ios-paper text-4xl text-blue-400"></i>,
        description: "Sistema inteligente de captura e análise de notícias sobre a Mottu com web scraping automático e análise de sentimento.",
        links: [
            { 
                name: "Central de Notícias", 
                path: "/noticias", 
                icon: <i className="ion-ios-paper text-blue-500"></i>, 
                detail: "Hub principal para acompanhar notícias sobre a Mottu com captura automática de fontes específicas (Dicas Mottu, MotoO), análise de sentimento, categorização inteligente e interface neumórfica responsiva." 
            },
        ]
    },
    {
                            ...
                            <div className="mt-6 sm:mt-8 neumorphic-container p-4 sm:p-6">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 text-center">
                                    <div className="hover:scale-110 transition-transform duration-300">
                                        <div className="text-2xl sm:text-3xl font-bold text-emerald-600" style={{fontFamily: 'Montserrat, sans-serif'}}>60+</div>
                                        <div className="text-xs sm:text-sm text-slate-600" style={{fontFamily: 'Montserrat, sans-serif'}}>Páginas Implementadas</div>
                                    </div>
                                    <div className="hover:scale-110 transition-transform duration-300">
                                        <div className="text-2xl sm:text-3xl font-bold text-blue-600" style={{fontFamily: 'Montserrat, sans-serif'}}>14</div>
