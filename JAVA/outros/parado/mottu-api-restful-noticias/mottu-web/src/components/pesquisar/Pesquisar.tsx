...
const searchData = [
    ...
    { term: 'performance', page: '/relatorios/performance-sistema', label: 'Performance do Sistema' },
    { term: 'manutencao', page: '/relatorios/manutencao', label: 'Relatório de Manutenção' },
    { term: 'manutenção', page: '/relatorios/manutencao', label: 'Relatório de Manutenção' },
    ...
    // Notícias
    { term: 'noticias', page: '/noticias', label: 'Central de Notícias' },
    { term: 'notícias', page: '/noticias', label: 'Central de Notícias' },
    { term: 'news', page: '/noticias', label: 'Central de Notícias' },
    { term: 'central noticias', page: '/noticias', label: 'Central de Notícias' },
    { term: 'central notícias', page: '/noticias', label: 'Central de Notícias' },
