...
const navItems: Array<{
        ...
        subGroups: [
            {
                ...
                icon: "ion-ios-home",
                items: [
                    { href: "/relatorios", label: "Página Principal", icon: "ion-ios-home" },
                    { href: "/relatorios/dashboard-ia", label: "Dashboard IA", icon: "ion-ios-bulb" }
                ]
            },
            {
                title: "Ocupação",
                ...
                items: [
                    ...
                    { href: "/relatorios/heatmap", label: "Heatmap", icon: "ion-ios-map" }
                ]
            },
            {
                title: "Análise",
                ...
                items: [
                    ...
                    { href: "/relatorios/comportamental", label: "Comportamental", icon: "ion-ios-people" },
                    { href: "/relatorios/analytics", label: "Analytics", icon: "ion-ios-analytics" }
                ]
            },
            {
                title: "Sistema",
                icon: "ion-ios-settings",
                items: [
                    { href: "/relatorios/performance-sistema", label: "Performance", icon: "ion-ios-speedometer" },
                    { href: "/relatorios/manutencao", label: "Manutenção", icon: "ion-ios-construct" },
                    { href: "/relatorios/notificacoes", label: "Notificações", icon: "ion-ios-notifications" }
                ]
            }
        ]
    },
    ...
    { href: "/noticias", label: "Notícias", icon: "ion-ios-paper", basePath: "/noticias" },
