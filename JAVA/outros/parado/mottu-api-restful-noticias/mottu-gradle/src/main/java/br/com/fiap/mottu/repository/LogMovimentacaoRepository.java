...
public interface LogMovimentacaoRepository extends JpaRepository<LogMovimentacao, Long> {
    ...
    /**
     * Deleta todos os logs de movimentação relacionados a um pátio
     */
    @Modifying(clearAutomatically = true, flushAutomatically = true)
    @Query("DELETE FROM LogMovimentacao l WHERE l.patio.idPatio = :patioId")
    void deleteByPatioIdPatio(@Param("patioId") Long patioId);
    
    /**
     * Deleta todos os logs de movimentação relacionados a um box
     */
    @Modifying(clearAutomatically = true, flushAutomatically = true)
    @Query("DELETE FROM LogMovimentacao l WHERE l.box.idBox = :boxId")
    void deleteByBoxIdBox(@Param("boxId") Long boxId);
    
    /**
     * Deleta todos os logs de movimentação relacionados aos boxes de um pátio
     */
    @Modifying(clearAutomatically = true, flushAutomatically = true)
    @Query("DELETE FROM LogMovimentacao l WHERE l.box.patio.idPatio = :patioId")
