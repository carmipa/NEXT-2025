-- Script para TESTAR e MONITORAR duplicações de estacionamento
-- Execute este script periodicamente ou após cada operação de estacionamento

-- ==================================================
-- 1. DETECTAR DUPLICAÇÕES ATIVAS (CRÍTICO)
-- ==================================================
SELECT 
    '⚠️ DUPLICAÇÃO DETECTADA!' as ALERTA,
    v.PLACA,
    COUNT(*) as TOTAL_ESTACIONAMENTOS_ATIVOS,
    LISTAGG(
        'ID: ' || e.ID_ESTACIONAMENTO || ' | Box: ' || b.NOME || ' | Pátio: ' || p.NOME_PATIO || ' | Data: ' || 
...
-- ==================================================
-- 2. VERIFICAR SE HÁ BOXES COM STATUS INCONSISTENTE
-- ==================================================
SELECT 
    '⚠️ INCONSISTÊNCIA BOX/ESTACIONAMENTO!' as ALERTA,
    b.ID_BOX,
    b.NOME as BOX_NOME,
...
-- ==================================================
SELECT 
    '📊 ESTACIONAMENTOS ATIVOS' as STATUS,
    e.ID_ESTACIONAMENTO,
    v.PLACA,
    b.ID_BOX,
    b.NOME as BOX_NOME,
...
-- ==================================================
-- 5. VERIFICAR SE HÁ BOXES OCUPADOS SEM ESTACIONAMENTO ATIVO
-- ==================================================
SELECT 
    '⚠️ BOX OCUPADO SEM ESTACIONAMENTO ATIVO!' as ALERTA,
    b.ID_BOX,
    b.NOME as BOX_NOME,
    b.STATUS as BOX_STATUS,
    b.DATA_ENTRADA,
