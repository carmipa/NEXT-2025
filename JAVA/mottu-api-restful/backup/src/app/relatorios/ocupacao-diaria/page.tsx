                            ...
                            <ResponsiveContainer width="100%" height="100%">
                                ...
                                <LineChart data={dataLog} margin={{ top: 10, right: 20, left: 10, bottom: 10 }}>
                                    ...
                                    <Tooltip 
                                        ...
                                        formatter={(_value, name, props:any) => {
                                            const p = props?.payload;
                                            if (name.includes('Ocupadas')) return [p?.ocupadas, 'Ocupadas'];
                                            if (name.includes('Livres')) return [p?.livres, 'Livres'];
                                            return [p?.totalVagas, 'Total'];
                                        }}
                                    />
                                    <Legend />
                                    <Line 
