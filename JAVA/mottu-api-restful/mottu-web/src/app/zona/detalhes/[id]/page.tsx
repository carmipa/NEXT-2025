                ...
                <div className="container max-w-4xl mx-auto neumorphic-container p-3 sm:p-6 md:p-8">
                    <div className="flex flex-col sm:flex-row justify-between items-start mb-4 sm:mb-6 gap-4">
                        <div className="flex-1">
                            <h1 className="text-lg sm:text-2xl md:text-3xl font-bold text-white">{zona.nome}</h1>
                            <p className="text-slate-300 text-xs sm:text-sm">Detalhes da Zona (ID: {zona.idZona})</p>
                        </div>
                        <div className="flex gap-2">
                            <Link href="/gerenciamento-patio/zona" className="btn btn-ghost text-xs sm:text-sm px-3 sm:px-4 py-2">
                    ...
                    <div className="p-3 sm:p-4 rounded-lg neumorphic-container">
                        <h2 className="text-lg sm:text-xl font-semibold mb-3 flex items-center">
                            <ZonaIcon className="mr-2 text-purple-600 w-5 h-5 sm:w-6 sm:h-6"/>Dados da Zona
                        </h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4 sm:gap-x-6 gap-y-2 sm:gap-y-3 text-xs sm:text-sm text-gray-800">
                            <div className="flex items-center gap-2">
                                <i className="ion-ios-pricetag text-purple-500 text-sm"></i>
                            ...
                            <div className="flex items-center gap-2">
                                <i className="ion-ios-key text-orange-500 text-sm"></i>
                                <span><strong>ID do Pátio:</strong> {zona.patioId || zona.patio?.idPatio || 'N/A'}</span>
                            </div>
                            <div className="flex items-center gap-2">
                                <i className="ion-ios-pulse text-blue-600 text-sm"></i>
