                ...
                <section className="container mx-auto px-4 py-6">
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-lg p-4 mb-4 flex flex-col md:flex-row gap-4 md:items-center md:justify-between">
                        ...
                        <div className="flex flex-wrap gap-2 items-center">
                            <button
                                className="px-3 py-1 rounded /40"
                            ...
                            <button className="px-3 py-1 rounded /40" onClick={undo} title="Desfazer">
                                <MdUndo />
                            </button>
                            <button className="px-3 py-1 rounded /40" onClick={redo} title="Refazer">
                                <MdRedo />
                            </button>
                    ...
                    <div className="mt-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                            ...
                            <textarea
                                className="w-full h-64 text-xs /60 text-white p-3 rounded"
                                readOnly
