...
export default function FeedbackPage() {
    ...
    if (isSubmitted) {
        return (
            <main className="min-h-screen text-white p-3 sm:p-6 md:p-12 flex items-center justify-center">
                <div className="container max-w-2xl mx-auto text-center">
                    <div className="bg-slate-800/80 backdrop-blur-sm rounded-xl shadow-2xl p-4 sm:p-6 md:p-8 border border-slate-700">
                        <div className="w-12 h-12 sm:w-16 sm:h-16 bg-green-500/20 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6">
                            <i className="ion-ios-checkmark text-green-400 text-2xl sm:text-3xl"></i>
                        </div>
                        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3 sm:mb-4" style={{fontFamily: 'Montserrat, sans-serif'}}>
                            Feedback Enviado!
                        </h1>
                        <p className="text-sm sm:text-base md:text-lg lg:text-xl text-slate-300 mb-6 sm:mb-8" style={{fontFamily: 'Montserrat, sans-serif'}}>
                        ...
                        <button
                            ...
                            className="bg-blue-600 hover:bg-blue-700 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-medium transition-all duration-300 hover:scale-105 flex items-center mx-auto text-sm sm:text-base"
                        >
                            <i className="ion-ios-refresh mr-2"></i>
                            <span className="hidden sm:inline">Enviar Novo Feedback</span>
                            <span className="sm:hidden">Novo Feedback</span>
                        </button>
                    </div>
                </div>
            </main>
    ...
    return (
        <main className="min-h-screen text-white p-3 sm:p-6 md:p-12">
            <div className="container max-w-4xl mx-auto">
                {/* Header */}
                <div className="text-center mb-8 sm:mb-12">
                    <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-3 sm:mb-4" style={{fontFamily: 'Montserrat, sans-serif'}}>
                        <i className="ion-ios-chatbubbles text-blue-400 mr-2 sm:mr-3 text-2xl sm:text-3xl md:text-4xl"></i>
                        <span>Feedback</span>
                    </h1>
                    <p className="text-sm sm:text-base md:text-lg lg:text-xl text-slate-300" style={{fontFamily: 'Montserrat, sans-serif'}}>
                ...
                <form onSubmit={handleSubmit} className="space-y-6 sm:space-y-8">
                    ...
                    <div className="bg-slate-800/80 backdrop-blur-sm rounded-xl shadow-2xl p-4 sm:p-6 border border-slate-700">
                        <h3 className="text-lg sm:text-xl font-semibold text-white mb-4 sm:mb-6 flex items-center" style={{fontFamily: 'Montserrat, sans-serif'}}>
                            <i className="ion-ios-person text-blue-400 mr-2 sm:mr-3 text-lg sm:text-xl"></i>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-gray-900 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all text-sm sm:text-base"
                    ...
                    <div className="bg-slate-800/80 backdrop-blur-sm rounded-xl shadow-2xl p-4 sm:p-6 border border-slate-700">
                        <h3 className="text-lg sm:text-xl font-semibold text-white mb-4 sm:mb-6 flex items-center" style={{fontFamily: 'Montserrat, sans-serif'}}>
                            <i className="ion-ios-flag text-purple-400 mr-2 sm:mr-3 text-lg sm:text-xl"></i>
                            ...
                            {tiposFeedback.map((tipo) => (
                                <label key={tipo.value} className="relative">
                                    <input
                                        ...
                                        className="sr-only"
                                    />
                                    <div className={`p-3 sm:p-4 border-2 rounded-lg cursor-pointer transition-all duration-300 ${
                                        formData.tipo === tipo.value 
                                            ? 'border-blue-500 bg-blue-500/20 shadow-lg shadow-blue-500/25' 
                                            : 'border-slate-600 hover:border-slate-500 bg-slate-700/30'
                                    }`}>
                                        <div className="font-medium text-white text-sm sm:text-base lg:text-lg flex items-center">
                                            <i className={`${tipo.icon} ${tipo.color} mr-2 text-sm sm:text-base`}></i>
                                            {tipo.label}
                                        </div>
                                        <div className="text-xs sm:text-sm text-slate-300 mt-1">{tipo.description}</div>
                                    </div>
                                </label>
                            ))}
                        </div>
                    ...
                    <div className="bg-slate-800/80 backdrop-blur-sm rounded-xl shadow-2xl p-4 sm:p-6 border border-slate-700">
                        <h3 className="text-lg sm:text-xl font-semibold text-white mb-4 sm:mb-6 flex items-center" style={{fontFamily: 'Montserrat, sans-serif'}}>
                            <i className="ion-ios-warning text-orange-400 mr-2 sm:mr-3 text-lg sm:text-xl"></i>
                            ...
                            {niveisUrgencia.map((nivel) => (
                                <label key={nivel.value} className="relative">
                                    <input
                                        ...
                                        className="sr-only"
                                    />
                                    <div className={`p-3 sm:p-4 border-2 rounded-lg cursor-pointer text-center transition-all duration-300 ${
                                        formData.urgencia === nivel.value 
                                            ? 'border-blue-500 bg-blue-500/20 shadow-lg shadow-blue-500/25' 
                                            : 'border-slate-600 hover:border-slate-500 bg-slate-700/30'
                                    }`}>
                                        <div className={`font-medium text-sm sm:text-base lg:text-lg flex items-center justify-center ${nivel.color}`}>
                                            <i className={`${nivel.icon} mr-1 sm:mr-2 text-sm sm:text-base`}></i>
                                            {nivel.label}
                                        </div>
                                    </div>
                                </label>
                    ...
                    <div className="bg-slate-800/80 backdrop-blur-sm rounded-xl shadow-2xl p-4 sm:p-6 border border-slate-700">
                        <h3 className="text-lg sm:text-xl font-semibold text-white mb-4 sm:mb-6 flex items-center" style={{fontFamily: 'Montserrat, sans-serif'}}>
                            <i className="ion-ios-chatbubble text-cyan-400 mr-2 sm:mr-3 text-lg sm:text-xl"></i>
                            <span>Mensagem *</span>
                        </h3>
                        <textarea
                            name="mensagem"
                            ...
                            required
                            rows={4}
                            className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-gray-900 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all resize-none text-sm sm:text-base"
                    ...
                    <div className="bg-slate-800/80 backdrop-blur-sm rounded-xl shadow-2xl p-4 sm:p-6 border border-slate-700">
                        <h3 className="text-lg sm:text-xl font-semibold text-white mb-4 sm:mb-6 flex items-center" style={{fontFamily: 'Montserrat, sans-serif'}}>
                            <i className="ion-ios-camera text-pink-400 mr-2 sm:mr-3 text-lg sm:text-xl"></i>
                            <span>Imagens (Opcional)</span>
                        </h3>
                        <div className="space-y-4 sm:space-y-6">
                            <div className="border-2 border-dashed border-slate-600 rounded-lg p-4 sm:p-6 md:p-8 text-center hover:border-slate-500 transition-colors">
                                <input
                                    ref={fileInputRef}
                                    type="file"
                                    multiple
                                ...
                                <button
                                    ...
                                    className="bg-blue-600 hover:bg-blue-700 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-medium transition-all duration-300 hover:scale-105 flex items-center mx-auto text-sm sm:text-base"
                                >
                                    <i className="ion-ios-cloud-upload mr-2 text-sm sm:text-base"></i>
                                    ...
                                    {previewImagens.map((preview, index) => (
                                        <div key={index} className="relative group">
                                            ...
                                            <button
                                                ...
                                                className="absolute -top-1 -right-1 sm:-top-2 sm:-right-2 bg-red-500 text-white rounded-full w-5 h-5 sm:w-6 sm:h-6 flex items-center justify-center text-xs sm:text-sm hover:bg-red-600 transition-colors opacity-0 group-hover:opacity-100"
                                            >
                                                ×
                                            </button>
                                        </div>
                    ...
                    <div className="bg-slate-800/80 backdrop-blur-sm rounded-xl shadow-2xl p-4 sm:p-6 border border-slate-700">
                        <h3 className="text-lg sm:text-xl font-semibold text-white mb-4 sm:mb-6 flex items-center" style={{fontFamily: 'Montserrat, sans-serif'}}>
                            <i className="ion-ios-link text-indigo-400 mr-2 sm:mr-3 text-lg sm:text-xl"></i>
                            <span>Localização do Problema</span>
                        </h3>
                        <input
                            type="url"
                            name="url"
                    ...
                    <div className="bg-slate-800/80 backdrop-blur-sm rounded-xl shadow-2xl p-4 sm:p-6 border border-slate-700">
                        <h3 className="text-lg sm:text-xl font-semibold text-white mb-4 sm:mb-6 flex items-center" style={{fontFamily: 'Montserrat, sans-serif'}}>
                            <i className="ion-ios-mail text-cyan-400 mr-2 sm:mr-3 text-lg sm:text-xl"></i>
                            <span>Escolha seu Provedor de Email</span>
                        </h3>
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2 sm:gap-3">
                            {emailProviders.map((provider) => (
                                <button
                                    ...
                                    className={`${provider.color} hover:opacity-80 text-white p-2 sm:p-3 rounded-lg transition-all duration-300 hover:scale-105 flex flex-col items-center space-y-1`}
                                >
                                    <i className={`${provider.icon} text-sm sm:text-base lg:text-lg`}></i>
                                    <span className="font-medium text-xs sm:text-sm">{provider.name}</span>
                                    <span className="text-xs opacity-75 hidden sm:block">{provider.popularity}</span>
                                </button>
                            ))}
                        </div>
                    ...
                    <div className="bg-slate-800/80 backdrop-blur-sm rounded-xl shadow-2xl p-4 sm:p-6 border border-slate-700">
                        <h3 className="text-lg sm:text-xl font-semibold text-white mb-3 sm:mb-4 flex items-center" style={{fontFamily: 'Montserrat, sans-serif'}}>
                            <i className="ion-ios-flash text-yellow-400 mr-2 sm:mr-3 text-lg sm:text-xl"></i>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-0">
                            ...
                            <button
                                ...
                                className="bg-gray-200 hover:bg-gray-300 disabled:bg-gray-600 text-gray-800 px-6 sm:px-8 py-3 sm:py-4 rounded-full font-medium transition-all duration-300 hover:scale-105 flex items-center disabled:cursor-not-allowed text-sm sm:text-base"
                            >
                                {isSubmitting ? (
                                    <>
                                        <div className="animate-spin rounded-full h-4 w-4 sm:h-5 sm:w-5 border-b-2 border-gray-800 mr-2 sm:mr-3"></div>
                                        <span className="hidden sm:inline">Detectando...</span>
                                        <span className="sm:hidden">Detectando...</span>
                                    </>
                                ) : (
                                    <>
                                        <i className="ion-ios-flash mr-2 text-sm sm:text-base"></i>
                                        <span className="hidden sm:inline">Envio Automático</span>
