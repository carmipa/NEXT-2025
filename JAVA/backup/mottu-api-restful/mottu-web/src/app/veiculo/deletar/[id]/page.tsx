...
export default function DeletarVeiculoPage() {
    ...
    if (isLoading) return (
        <>
            <main className="flex justify-center items-center min-h-screen relative z-20"><Loader2 className="h-12 w-12 animate-spin text-[var(--color-mottu-light)]" /></main>
        </>
    );

    if (error && !veiculo) return (
        <>
            <main className="flex justify-center items-center min-h-screen p-4 relative z-20">
