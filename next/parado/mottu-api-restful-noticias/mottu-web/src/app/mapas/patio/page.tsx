                ...
                <div className="container mx-auto px-4 py-6">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
                        <div>
                            ...
                            <p className="text-slate-300 text-sm">Visualize os pátios em tempo real</p>
                        </div>
                        <a
                            href="/mapas"
                            className="inline-flex items-center gap-2 px-6 py-3 bg-slate-700 hover:bg-slate-600 text-white rounded-xl transition-all duration-300 hover:scale-105 shadow-lg"
                    ...
                    {/* Seletor de Pátio - Estilo Moderno */}
                    <div className="flex gap-4 bg-black/30 backdrop-blur-sm rounded-2xl p-2 shadow-inner">
                        <button
                            ...
                            className={`flex-1 flex items-center justify-center gap-3 px-6 py-4 rounded-xl font-bold transition-all duration-300 ${
                                selectedMapa === 'guarulhos'
                                    ...
                                    : 'bg-slate-700/50 text-slate-300 hover:bg-slate-700/70 hover:scale-102'
                            }`}
                            style={{fontFamily: 'Montserrat, sans-serif'}}
                        >
                            <i className="ion-ios-home text-2xl"></i>
                            <span className="text-lg">Guarulhos</span>
                        </button>
                        <button
                            ...
                            style={{fontFamily: 'Montserrat, sans-serif'}}
                        >
                            <i className="ion-ios-pin text-2xl"></i>
                            <span className="text-lg">Limão</span>
                        </button>
                    </div>
                </div>
            </div>
